	...
	r.Group(func(r chi.Router) {
		...
		r.Group(func(r chi.Router) {
			...
			r.Route("/api/admin", func(r chi.Router) {
				...
				r.Get("/ai-runs", adminHandler.AIRuns.List)
				r.Get("/ai-runs/{id}", adminHandler.AIRuns.Get)
				r.Get("/ai-templates", adminHandler.AITemplates.ListPrompts)
				r.Post("/ai-templates", adminHandler.AITemplates.SavePrompt)
				r.Put("/ai-templates/{id}", adminHandler.AITemplates.SavePrompt)
				r.Post("/ai-templates/{id}/publish", adminHandler.AITemplates.PublishPrompt)
				r.Post("/ai-templates/preview", adminHandler.AITemplates.PreviewPrompt)
				r.Get("/ai-tool-templates", adminHandler.AITemplates.ListTools)
				r.Post("/ai-tool-templates", adminHandler.AITemplates.SaveTool)
				r.Put("/ai-tool-templates/{id}", adminHandler.AITemplates.SaveTool)
				r.Post("/ai-tool-templates/{id}/publish", adminHandler.AITemplates.PublishTool)
